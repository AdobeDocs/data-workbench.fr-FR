---
description: Instructions relatives à l’installation et à la configuration d’Apache Server 2.0.40, 2.0.42 ou version ultérieure, d’Apache Server 2.2 ou d’Apache Server 2.4 sous Linux, Sun Solaris ou FreeBSD.
title: Apache Server 2.0.40, 2.0.42 ou version ultérieure et Apache Server 2.2 ou 2.4 sous Linux, Solaris ou FreeBSD
...
# Apache Server 2.0.40, 2.0.42 ou version ultérieure et Apache Server 2.2 ou 2.4 sous Linux, Solaris ou FreeBSD{#apache-server-or-later-and-apache-server-or-on-linux-solaris-or-freebsd}
...
* Apache Server 2.0.40 s’exécute sous RedHat Linux 7.x ou version ultérieure, ou sous Sun Solaris SPARC 2.6 ou version ultérieure.
* Apache Server 2.0.40, 2.0.42 ou version ultérieure, Apache Server 2.2 ou Apache Server 2.4 sous Linux, Sun Solaris ou FreeBSD
...
* Apache Server 2.2 s’exécute sous RedHat Linux 7.x ou version ultérieure ou sous Sun Solaris SPARC 2.6 ou version ultérieure.
...
## Activation de la connexion sur le même serveur {#section-2e2f1875a5304cdfa2cbcd0680683cfd}

Cette section décrit la procédure à suivre pour vous connecter au même serveur.

1. Utilisez le client Administrateur Lotus Domino pour vous connecter au serveur Lotus Domino qui fonctionne en même temps.
1. Dans Lotus Domino Administrator, cliquez sur l’onglet Fichiers, puis double-cliquez sur Configuration en même temps - stconfig.nsf pour ouvrir le fichier Configuration en même temps.
...
1. Définissez l’indicateur de journalisation de la conversation sur &quot;strict&quot; et le type de service Capture sur &quot;0x1000&quot;.
1. Enregistrez et fermez le formulaire Community Services, puis fermez le fichier de configuration simultanée.
1. Redémarrez le serveur Simultané.
