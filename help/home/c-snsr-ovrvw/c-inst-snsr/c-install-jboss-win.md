---
description: Instructions détaillées pour l’installation et la configuration de Sensor pour JBoss Server 4.0.5 ou version ultérieure sous Microsoft Windows Server 2000 ou version ultérieure.
title: JBoss Server sous Windows Server 2000 ou version ultérieure
...
# JBoss Server sous Windows Server 2000 ou version ultérieure{#jboss-server-on-windows-server-or-later}

Instructions détaillées pour l’installation et la configuration de Sensor pour JBoss Server 4.0.5 ou version ultérieure sous Microsoft Windows Server 2000 ou version ultérieure.
...
Avant de modifier le script de démarrage, assurez-vous que la variable JAVA_HOME est définie dans l’environnement Windows.

Dans le [!DNL run.bat] fichier (par exemple, C:\jboss-4.0.5.GA\bin\run.bat), ajoutez les lignes suivantes à la fin du fichier juste avant les lignes &quot;echo&quot; qui précèdent la commande de démarrage du serveur JBoss :
