 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Désactive le champ spécifié </p> <p>Les utilisateurs peuvent éliminer les champs qu’ils n’utilisent pas ou qu’ils ne souhaitent pas stocker. Si le champ utilise des valeurs de chaîne, sa désactivation transmet une chaîne vide. Si le champ prend des valeurs numériques, sa désactivation transmet le nombre zéro (0). Vous pouvez désactiver les champs suivants : 
     ...
     </ul> </p> <p>Exemple : <span class="filepath"> DisableField xtrackingid</span> </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Permet de désactiver le suivi des visiteurs, qui peut être utilisé pour se conformer aux stratégies d’exclusion. </p> <p>Lorsqu’il est activé, <span class="wintitle"> Sensor</span> ne consigne pas de "paquet" pour un visiteur dont le cookie V1st est défini sur l’ID de confidentialité spécifié. Comme aucune information n’est consignée pour ces visiteurs, aucune information sur ces visiteurs n’est envoyée au serveur <span class="keyword"> de l’outil de</span> données pour traitement. </p> <p>Pour activer cette fonctionnalité, vous devez effectuer les étapes suivantes : 
     <ol id="ol_5D658C5E4AB14F419029E0FFC52F1310"> 
      <li id="li_BF056439F92148169BF592731264C3CD"> PrivacyID doit être défini avec la valeur 0 (zéro) dans le fichier <span class="filepath"> xlogd.conf</span> du <span class="wintitle"> capteur</span>. <p>Exemple : <span class="filepath"> PrivacyID 0</span> </p> </li> 
      <li id="li_3E20F068C2F94512A92F284C80273B1C">Les propriétaires de sites Web doivent écrire du code pour définir des cookies visiteurs (V1st) de sorte que la valeur de l’identifiant de cookie corresponde à la valeur de l’identifiant de confidentialité définie sur "<span class="filepath"> txlogd.conf</span>". </li> 
     </ol> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_598C3CDA5AA440228AF88C3BE4A8F77C"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Définissez ce paramètre uniquement lorsque vous travaillez avec Adobe Consulting Services. </p> <p>Indique au capteur <span class="wintitle"> IIS</span> lequel des deux "hameoks" de journalisation possibles doit être utilisé pour consigner un paquet. </p> <p>Utilisez ce paramètre lorsque le <span class="wintitle"> capteur</span> IIS ne consigne pas correctement les paquets. Ce paramètre est défini sur "off" si le hook de journalisation par défaut ne fonctionnait pas correctement. La valeur par défaut est "on". </p> <p>Exemple : <span class="filepath"> IISCaptureBytesEnvoyé sur</span> </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_88696CCA93874BB683538BD614E07890"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Définissez ce paramètre uniquement lorsque vous travaillez avec Adobe Consulting Services. </p> <p>Indique au <span class="wintitle"> capteur</span> lequel des deux crochets possibles doit être utilisé pour définir le cookie v1st. </p> <p>Utilisez ce paramètre lorsque Apache <span class="wintitle"> Sensor</span> ne définit pas correctement le cookie v1st. Ce paramètre est défini sur "yes" si le hook par défaut ne définit pas correctement le cookie v1st. La valeur par défaut est "no". </p> <p>Exemple : <span class="filepath"> ApacheUseAlternateHandler non</span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> ApacheUseTwoHandlers </td> 
   <td colname="col2"> <p>Définissez ce paramètre uniquement lorsque vous travaillez avec Adobe Consulting Services. </p> <p>Indique au <span class="wintitle"> capteur</span> de tenter de définir le cookie v1st dans les deux crochets. </p> <p>Utilisez ce paramètre lorsque Apache <span class="wintitle"> Sensor</span> ne définit pas correctement le cookie v1st. La valeur par défaut est "yes". </p> <p>Si la valeur est "yes" et que le cookie v1st n’est pas correctement défini dans le premier hook, le second est utilisé. Si la valeur est "no", vous devez définir le paramètre ApacheUseAlternateHandler pour indiquer quel hook utiliser pour définir le cookie v1st. </p> <p>Exemple : <span class="filepath"> ApacheUseTwoHandlers oui</span> </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p>NewUserCacheControl </p> <p>CacheControl </p> </td> 
