...
La condition [!DNL Compare] compare les valeurs numériques ou de chaîne. Pour comparer des valeurs de chaîne, vous pouvez indiquer si la casse doit être prise en compte.

Les paramètres de la condition [!DNL Compare] sont décrits dans le tableau suivant :
...
<table id="table_05B1FBB2AED242D99081E62BE2FBEC60"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2">Vrai ou faux. Utilisé uniquement si le type est <span class="wintitle"> LEXICAL</span>. Si la valeur est définie sur false, les lettres majuscules et minuscules sont considérées comme égales. </td> 
  ...
  <tr> 
   ...
   <td colname="col2">Type de comparaison à effectuer. Les types disponibles sont <span class="wintitle"> LEXICAL</span>, <span class="wintitle"> NUMERIC</span> et <span class="wintitle"> DATETIME</span>. Pour la description des types, voir <a href="../../../../home/c-dataset-const-proc/c-conditions/c-test-ops/c-test-types.md#concept-a9fca97a2f03464cb0cbab8b5f809d0a"> Types de test pour les opérations de test</a>. </td> 
   <td colname="col3"> <span class="wintitle"> LEXIQUE</span> </td> 
  </tr> 
 </tbody> 
</table>

Cet exemple utilise une condition [!DNL Compare] pour définir [!DNL Log Entry Condition]. Lorsque le serveur de l’outil de données lit chaque enregistrement de données de événement, il compare les valeurs numériques x-age et 55. Si pour une entrée de journal donnée, x-age est inférieur ou égal à 55, l&#39;entrée de journal est incluse dans le processus de construction du jeu de données.

![](assets/cfg_Condition_CompareCondition.png)

## Non vide {#section-1decb9d887894073a1b6b3d985729ac8}

La condition [!DNL Not Empty] vérifie un champ pour déterminer s’il contient une valeur ou s’il est vide. La condition est remplie pour toute entrée de journal dont la valeur pour le champ [!DNL Input] n&#39;est pas vide.

Les paramètres de la condition [!DNL Not Empty] sont décrits dans le tableau suivant :
...
La condition [!DNL Range] utilise un champ d’entrée et détermine si la valeur de ce champ est incluse, de manière inclusive, dans les valeurs de paramètre minimales (Min) et maximales (Max) données.

Les paramètres de la condition [!DNL Range] sont décrits dans le tableau suivant :
...
<table id="table_1587D8D333804FC28024C0DFC2F2D4D3"> 
 ...
 <tbody> 
  <tr> 
   <td colname="col1"> Respect de la casse </td> 
   <td colname="col2">Vrai ou faux. Utilisé uniquement si le <span class="wintitle"> type</span> est <span class="wintitle"> LEXICAL</span>. Si la valeur est définie sur false, les lettres majuscules et minuscules sont considérées comme égales. </td> 
   <td colname="col3"> true </td> 
  </tr> 
  <tr> 
   <td colname="col1"> Commentaires </td> 
...
Cet exemple utilise une condition [!DNL Range] pour définir [!DNL Log Entry Condition]. Comme le serveur de l’outil de données lit chaque enregistrement [!DNL event data], il compare les valeurs numériques x-age et 55. Si pour une entrée de journal donnée, x-age est d&#39;au moins 55 ans, l&#39;entrée de journal est incluse dans le processus de construction des jeux de données. Cet exemple exécute la même fonction que l&#39;exemple de condition [!DNL Compare]. Voir [Comparaison](../../../../home/c-dataset-const-proc/c-conditions/c-test-ops/c-test-op-con.md#section-fb2bdb3838504099b324b9838cdeeaac).
...
Le test de condition [!DNL Regular Expression] utilise la correspondance de modèles d&#39;expressions régulières (voir [Expressions régulières](../../../../home/c-dataset-const-proc/c-reg-exp.md#concept-070077baa419475094ef0469e92c5b9c)) pour déterminer si la valeur du champ d&#39;entrée spécifié contient une chaîne qui correspond à l&#39;un des modèles spécifiés dans le paramètre Correspond.

Si l’entrée est un vecteur de chaînes, seule la première valeur du vecteur est utilisée pour le test. La condition [!DNL Regular Expression] effectue des comparaisons de chaînes complètes. Si vous souhaitez identifier des sous-chaînes, vous devez ajouter en préfixe et en suffixe &quot;.*&quot; à la chaîne.

Les paramètres de la condition [!DNL Regular Expression] sont décrits dans le tableau suivant :
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Le ou les modèles d’expression standard à faire correspondre à la valeur du champ d’entrée. </p> <p> <b> Pour ajouter un modèle d’expression normal</b> 
     <ol id="ol_6D6467FF74334DEA8E8625C3B155D11D"> 
      <li id="li_9E13A63558FF44749C2E49BD50B7F770">Cliquez avec le bouton droit <span class="uicontrol"> Correspond à </span>. </li> 
      <li id="li_195A2F3B6B9442F5B1DACDE0FC96CE5C">Cliquez sur <span class="uicontrol"> Ajouter nouveau</span> &gt; <span class="uicontrol"> Expression régulière</span>. </li> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Chaîne(s) à comparer à la valeur du champ d’entrée. </p> <p> <b>Pour ajouter une chaîne</b> 
     <ol id="ol_9E32218C771445D88357960475FAD6EB"> 
      <li id="li_A700747858D0470491783E9B3933DAFE">Cliquez avec le bouton droit <span class="uicontrol"> Correspond à </span>. </li> 
      <li id="li_9D1A2462EA404B0F84426176737CAFED">Cliquez sur <span class="uicontrol"> Ajouter new</span> &gt; <span class="uicontrol"> Chaîne</span>. </li> 
...
Cet exemple utilise les données collectées à partir du trafic du site Web pour illustrer l&#39;utilisation de la condition [!DNL String Match]. La condition vérifie si le champ d&#39;entrée (cs-uri-stem) correspond à l&#39;une des deux chaînes spécifiées dans le paramètre Correspond et si le champ cs-uri-stem est la chaîne exacte [!DNL /navigation/footer.asp] ou la chaîne exacte [!DNL /navigation/header.asp].
