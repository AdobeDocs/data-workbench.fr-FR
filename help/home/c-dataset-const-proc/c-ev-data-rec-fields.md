...
<table id="table_98E135FE4EAF44D6ADEB3C6C1C0BF6A4">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Chaîne de référent HTTP envoyée par le client au serveur avec la demande. </p> <p> Exemple : <span class="filepath"> https://www.mysite.net/cgi-bin/websearch?qry </span> </p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Type de méthode de la requête HTTP. </p> <p> Exemple : GET </p> <p> Référence : <span class="filepath"> https://www.w3.org/TR/2000/NOTE-shoplogfileformat-20001115/#field_method </span> </p> </td>
  </tr>
  <tr>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Code d’état renvoyé au client par le serveur. </p> <p> Exemple : 200 </p> <p> Référence : <span class="filepath"> https://www.w3.org/Protocols/rfc2616/rfc2616-sec10.html </span> </p> </td>
  </tr>
  <tr>
...
<table id="table_3B008F1314804A69AE69E8F94908F497">
 ...
 <tbody>
  ...
  <tr>
   ...
   <td colname="col2"> <p>Nom d’hôte complet du référent. </p> <p> Exemple : Si cs(referrer) est <span class="filepath"> https://my.domain.com/my/page </span>, cs(referrer-host) est <span class="filepath"> my.domain.com </span>. </p> </td>
  </tr>
  <tr>
