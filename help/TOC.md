...
+ Notes de mise à jour {#release-notes}
   ...
   + [Notes de mise à jour des outils de données version 6.1](home/c-release-notes-insight/c-release-notes-insight-62/c-release-notes-insight-62.md)
...
+ Client {#client}
   ...
   + Exportation de données {#export-data}
      ...
      + [Exportation d’un segment à l’aide d’une diffusion S/FTP](home/c-get-started/c-exp-data-seg-exp/exporting-data.md)
      ...
      + [Exporter vers Adobe Target](home/c-get-started/c-exp-data-seg-exp/dwb-target-export.md)
   ...
   + Visualisations {#visualizations}
      ...
      + Effectuer des sélections {#make-selections}
         ...
         + [Zoom pour afficher les visualisations](home/c-get-started/c-vis/c-sel-vis/dwb-zoom-regression-view.md)
   ...
   + Visualisations d’analyse {#analysis-visualizations}
      + [Présentation des visualisations d’analyse](home/c-get-started/c-analysis-vis/c-analysis-vis.md)
      ...
      + Filtrage des éditeurs {#filter-editors}
         ...
         + [Enregistrer et charger les filtres](home/c-get-started/c-analysis-vis/c-filter-editors/t-save-filters.md)
      ...
      + Graphiques {#graphs}
         ...
         + [Ajout et modification d’une mesure](home/c-get-started/c-analysis-vis/c-graphs/c-add-chg-metrics.md)
         ...
         + [Graphique Analyse de régression](home/c-get-started/c-analysis-vis/c-graphs/c-regression-analysis.md)
      ...
      + Analyse guidée {#guided-analysis}
         + [Présentation de l’analyse guidée](home/c-get-started/c-analysis-vis/c-guided-analysis/c-guided-analysis.md)
      ...
      + Navigateurs de chemins {#path-browsers}
         ...
         + [Afficher le début et la fin des chemins](home/c-get-started/c-analysis-vis/c-path-browsers/c-disp-starts-.md)
         ...
         + [Afficher d’autres éléments dans les chemins](home/c-get-started/c-analysis-vis/c-path-browsers/c-el-paths.md)
      ...
      + Process Map {#process-maps}
         ...
         + [Ajout d’une légende](home/c-get-started/c-analysis-vis/c-proc-maps/c-add-callouts.md)
      ...
      + Tableaux {#tables}
         ...
         + [Ajout et modification d’une mesure](home/c-get-started/c-analysis-vis/c-tables/c-add-metrics.md)
      ...
      + Feuilles de calcul {#worksheets}
         ...
         + [Expressions de feuille de calcul](home/c-get-started/c-analysis-vis/c-wksts/c-wkst-exp.md)
   ...
   + Interfaces administratives {#admin-ui}
      ...
      + [Interface de schéma de jeu de données](home/c-get-started/c-admin-intrf/c-dtst-sch-intrf.md)
      ...
      + Gestionnaire de profils {#profile-mgr}
         ...
         + [Publication de fichiers dans votre profil de travail](home/c-get-started/c-admin-intrf/c-prof-mgr/t-pub-files-wkg-prof.md)
         + [Suppression de fichiers de votre profil de travail](home/c-get-started/c-admin-intrf/c-prof-mgr/t-del-files-wkg-prof.md)
      ...
      + Entraîneur de jeux de données {#dataset-mgrs}
         ...
         + Cartes de dépendance {#dep-maps}
            ...
            + [Afficher les détails du noeud](home/c-get-started/c-admin-intrf/c-dataset-mgrs/c-dep-maps/c-view-node-dtls.md)
            ...
            + [Modification des composants de profil](home/c-get-started/c-admin-intrf/c-dataset-mgrs/c-dep-maps/t-edit-prof-comp.md)
   ...
   + Fonctions d’interface et d’analyse {#ui-analysis-features}
      + [Fonctions d’interface et d’analyse](home/c-get-started/c-intf-anlys-ftrs/c-intf-anlys-ftrs.md)
      ...
      + [Configuration de l’interface de schéma de jeu de données](home/c-get-started/c-intf-anlys-ftrs/t-dataset-schema-intf.md)
   ...
   + Syntaxe du langage de requête {#qry-lang-syntx}
      ...
      + [Syntaxe de n’importe quelle expression](home/c-get-started/c-qry-lang-syntx/c-syntx-exp.md)
   ...
   + Transformations de données {#data-transformations}
      ...
      + Types de transformations {#transform-types}
         ...
         + Transformations standard {#standard-transformations}
            ...
            + [Hachage](home/c-dataset-const-proc/c-data-trans/c-transf-types/c-standard-transf/c-hash.md)
...
+ Serveur de rapports {#report-server}
   ...
   + Installation du portail des rapports {#install-report-portal}
      ...
      + [Modification du fichier Profiles.xml](home/c-rpt-oview/c-install-rpt-port/t-edit-prof-file.md)
...
+ Balisage de pages {#page-tagging}
   ...
   + [Suivi De L’Activité Des Visiteurs Dans Le Contenu De Média Riche Flash](home/c-undst-pg-tag/t-trk-vstr-act.md)
...
+ Metrics, dimensions, and filters {#metrics}
   ...
   + Built-in Metrics, Dimensions, and Filters {#built-in-metrics}
      + [A propos des mesures, des dimensions et des filtres intégrés](home/c-about/c-builtin-metrics-dims/c-builtin-metrics-dims.md)
   ...
   + Profils de ligne de base {#baseline-profiles}
      + [Présentation des profils de ligne de base](home/c-about/c-about-baseline-profiles/c-about-baseline-profiles.md)
...
+ Geography {#geography}
   ...
   + Data Services {#data-services}
      ...
      + Installation d’un service de données {#install-data-service}
         ...
         + [Installation du profil du service de données](home/c-geo-oview/c-wk-data-svcs/c-install-data-svc/c-inst-data-svc-prof.md)
...
+ Controlled experiments {#experiments}
   ...
   + Création d’une expérience contrôlée {#create-controlled-experiment}
      ...
      + [Forme d&#39;une hypothèse](home/c-undst-ctrld-exp/t-crt-ctrld-exp/c-frm-hyp.md)
...
+ Administration et installation des serveurs {#server-admin-install}
   ...
   + Installation des serveurs des outils de données {#install-servers}
      ...
      + DPU du serveur Insight {#insight-server-dpu}
         ...
         + [Installation des fichiers du programme du serveur Insight](home/c-inst-svr/c-install-ins-svr/t-install-proc-inst-svr-dpu/t-install-prgm-files.md)
   ...
   + Administration du serveur des outils de données {#admin-dwb-server}
      ...
      + Access Control {#access-control}
         ...
         + [Présentation des groupes de contrôle d&#39;accès](home/c-inst-svr/c-admin-inst-svr/c-config-acs-ctrl/c-undst-acc-ctrl-grps.md)
      ...
      + Surveillance de l&#39;espace disque {#monitor-disk-space}
         ...
         + [Surveillance de l’espace de données d’événement](home/c-inst-svr/c-admin-inst-svr/c-mntr-disk-spc/t-mntr-evt-data-spc.md)
      ...
      + [Contrôle des événements administratifs](home/c-inst-svr/c-admin-inst-svr/t-mntr-adm-evts.md)
   ...
   + Répéteur {#repeater}
      ...
      + Configurer des {#configure}
         ...
         + [Configuration du contrôle d’accès pour les machines Target](home/c-inst-svr/c-rptr-fntly/c-cnfg-rptr-fntly/t-cfg-acc-ctrll-tgt-mach.md)
   ...
   + Administration générale des systèmes {#general-syst-admin}
      ...
      + [Contrôle des événements pour les erreurs](home/c-inst-svr/c-gen-syst-admin/c-mntr-errs.md)
...
+ Sensor {#sensor}
   ...
   + Administration {#admin-sensor}
      ...
      + [Contrôle des événements administratifs](home/c-snsr-ovrvw/admin-sensor/c-mntr-admin-evts.md)
      + [Modification du serveur Target Data Workbench](home/c-snsr-ovrvw/admin-sensor/t-trgt-ins-svr.md)
   ...
   + Champs d’enregistrement des données d’événement {#event-data-record}
      ...
      + [Champs d’enregistrement des données d’événement de ligne de base](home/c-snsr-ovrvw/c-evnt-data-rcd-flds/c-bsln-evnt-data.md)
...
+ Installation du profil de surveillance {#monitor}
   ...
   + des activités {#workspace}
      ...
      + [Espace de travail Statut du profil des outils de données](home/monitoring-installation/monitoring-profiles/monitoring-profile-using.md)
   ...
   + Dimensions et mesures des profils des outils de données {#monitoring-appendix}
      ...
      + [Dimensions dans le profil d’état du profil des outils de données](home/monitoring-installation/monitoring-appendix/monitoring-profile-status.md)
   ...
   + Tableaux de bord {#dashboards}
      ...
      + Affichage des tableaux de bord {#viewing-dashboards}
         ...
         + Navigateur de tableaux de bord] {#dashboard-browser}
            ...
            + [Affichage du navigateur du tableau de bord](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-browser/c-dashboard-browser-views.md)
         ...
         + [Hyperlien du tableau de bord](home/c-adobe-data-workbench-dashboard/c-dashboards/c-opening-and-viewing-dashboards/c-dashboard-hyperling.md)
      + [Paramètre de requête](home/c-adobe-data-workbench-dashboard/c-dashboards/c-query-to-parameter.md)
      ...
      + [Autres fonctions du tableau de bord](home/c-adobe-data-workbench-dashboard/c-dashboards/c-other-dashboard-functions.md)
      + [Partage des tableaux de bord et contrôles d’accès](home/c-adobe-data-workbench-dashboard/c-dashboards/c-dashboard-sharing-and-access-controls.md)
   + Sélection {#select}
      ...
      + [Sélections inter-profils](home/c-adobe-data-workbench-dashboard/c-making-selections-within-the-dashboard/c-cross-profile-selections.md)
   + [Exportation de données](home/c-adobe-data-workbench-dashboard/c-exporting-data.md)
   + [Contrôles d’accès aux tableaux de bord](home/c-adobe-data-workbench-dashboard/c-dashboard-access-controls.md)
...
+ Administrateur de tableau de bord {#admin}
   ...
   + Déploiement des tableaux de bord {#dashboard-deployment}
      ...
      + [Ajouter la clé de licence du tableau de bord](home/c-preparing-for-dashboard-installation/c-dashboard-deployment/t-add-dashboard-license-key.md)
   ...
   + Connexions de profil {#profile-connections}
      ...
      + [Ajout d’une connexion de profil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-adding-a-profile-connection.md)
      + [Modification d’une connexion de profil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-editing-a-profile.md)
      + [Suppression d’une connexion de profil](home/c-preparing-for-dashboard-installation/c-managing-profile-connections/t-removing-a-profile-connection.md)
   + Schéma {#schema}
      + [Gestion du schéma](home/c-preparing-for-dashboard-installation/c-managing-the-schema/c-managing-the-schema.md)
      + [Initialisation et mise à jour de la définition de schéma d’un profil](home/c-preparing-for-dashboard-installation/c-managing-the-schema/t-initializing-and-updating-a-profiles-schema-definition.md)
   + Dossiers {#folders}
      ...
      + [Déplacement des tableaux de bord et des dossiers](home/c-preparing-for-dashboard-installation/c-managing-folders/t-moving-dashboards-and-folders.md)
...
+ Mise en oeuvre des outils de données {#implement}
   ...
   + [Structures dénombrables de conception de schéma](home/dwb-implement-overview/dwb-implement-architecture/dwb-implement-arch-countable.md)
   ...
   + Configuration et implémentation {#implement-configure}
      ...
      + [Configuration de l’heure d’événement](home/dwb-implement-overview/dwb-implement-configure/dwb-implement-event-time.md)
...
+ [Intégration des outils de données à Adobe Target](home/dwb-adobe-target.md)
